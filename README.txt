...
a persistence unit "simulacionPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "simulacion/pom.xml":
...
artifact ("simulacion.war") is already built. You can build
